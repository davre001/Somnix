...
export function OddsBar({ greenOdds, redOdds }: OddsBarProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-3 p-4 sm:p-5 rounded-2xl bg-[#0c0c10] border border-zinc-800/80 shadow-md">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-base font-black text-emerald-400">{greenOdds}%</span>
        </div>

        <div className="flex items-center gap-2">
          <span className="font-mono text-base font-black text-red-400">{redOdds}%</span>
      ...
      {/* Vibrant Split Bar */}
      <div className="w-full h-4 bg-black rounded-lg overflow-hidden flex p-0.5 border border-zinc-800">
        <div
